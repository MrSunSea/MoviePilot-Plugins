...
class CloudScraper(_PluginBase):
    # 插件名称
    plugin_name = "云盘媒体刮削"
    # 插件描述
    plugin_desc = "监控云盘目录文件变化，自动转移+刮削（支持 rclone move 到云盘其他目录）"
    # 插件图标
    plugin_icon = "cloud.png"
    # 插件版本
    plugin_version = "1.0"
    # 插件作者
    plugin_author = "Mr.SunSea"
    # 作者主页
    author_url = "https://github.com/MrSunSea"
    # 插件配置项ID前缀
    plugin_config_prefix = "cloudscraper_"
    # 加载顺序
    plugin_order = 4
    # 可使用的用户级别
    auth_level = 1
